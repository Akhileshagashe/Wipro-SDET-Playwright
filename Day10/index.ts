...
addEmp({ id: 10, name: "Shyam", role: Role.User });
addEmp({ id: "xyz", name: "Sanskar", role: Role.User });
addEmp({ id: 20, name: "Akhilesh", role: Role.Admin, priviledges: [Priviledge.Read, Priviledge.Write] });
getEmp(0);
getEmp(1);
getEmp(2);
